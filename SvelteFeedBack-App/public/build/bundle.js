...
var app = (function () {
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "card svelte-ia0rtu");
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", button_class_value = "" + (null_to_empty(/*style*/ ctx[0]) + " svelte-e4kpsk"));
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!current || dirty & /*style*/ 1 && button_class_value !== (button_class_value = "" + (null_to_empty(/*style*/ ctx[0]) + " svelte-e4kpsk"))) {
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "class", "svelte-1tvgqix");
    			add_location(input0, file$5, 14, 6, 284);
    			attr_dev(label0, "for", "num1");
    			attr_dev(label0, "class", "svelte-1tvgqix");
    			add_location(label0, file$5, 15, 6, 392);
    			attr_dev(li0, "class", "svelte-1tvgqix");
    			add_location(li0, file$5, 13, 4, 272);
    			attr_dev(input1, "type", "radio");
    			attr_dev(input1, "id", "num2");
    			attr_dev(input1, "name", "rating");
    			input1.value = "2";
    			input1.checked = input1_checked_value = /*selected*/ ctx[0] === 2;
    			attr_dev(input1, "class", "svelte-1tvgqix");
    			add_location(input1, file$5, 18, 6, 448);
    			attr_dev(label1, "for", "num2");
    			attr_dev(label1, "class", "svelte-1tvgqix");
    			add_location(label1, file$5, 19, 6, 556);
    			attr_dev(li1, "class", "svelte-1tvgqix");
    			add_location(li1, file$5, 17, 4, 436);
    			attr_dev(input2, "type", "radio");
    			attr_dev(input2, "id", "num3");
    			attr_dev(input2, "name", "rating");
    			input2.value = "3";
    			input2.checked = input2_checked_value = /*selected*/ ctx[0] === 3;
    			attr_dev(input2, "class", "svelte-1tvgqix");
    			add_location(input2, file$5, 22, 6, 612);
    			attr_dev(label2, "for", "num3");
    			attr_dev(label2, "class", "svelte-1tvgqix");
    			add_location(label2, file$5, 23, 6, 720);
    			attr_dev(li2, "class", "svelte-1tvgqix");
    			add_location(li2, file$5, 21, 4, 600);
    			attr_dev(input3, "type", "radio");
    			attr_dev(input3, "id", "num4");
    			attr_dev(input3, "name", "rating");
    			input3.value = "4";
    			input3.checked = input3_checked_value = /*selected*/ ctx[0] === 4;
    			attr_dev(input3, "class", "svelte-1tvgqix");
    			add_location(input3, file$5, 26, 6, 776);
    			attr_dev(label3, "for", "num4");
    			attr_dev(label3, "class", "svelte-1tvgqix");
    			add_location(label3, file$5, 27, 6, 884);
    			attr_dev(li3, "class", "svelte-1tvgqix");
    			add_location(li3, file$5, 25, 4, 764);
    			attr_dev(input4, "type", "radio");
    			attr_dev(input4, "id", "num5");
    			attr_dev(input4, "name", "rating");
    			input4.value = "5";
    			input4.checked = input4_checked_value = /*selected*/ ctx[0] === 5;
    			attr_dev(input4, "class", "svelte-1tvgqix");
    			add_location(input4, file$5, 30, 6, 940);
    			attr_dev(label4, "for", "num5");
    			attr_dev(label4, "class", "svelte-1tvgqix");
    			add_location(label4, file$5, 31, 6, 1048);
    			attr_dev(li4, "class", "svelte-1tvgqix");
    			add_location(li4, file$5, 29, 4, 928);
    			attr_dev(input5, "type", "radio");
    			attr_dev(input5, "id", "num6");
    			attr_dev(input5, "name", "rating");
    			input5.value = "6";
    			input5.checked = input5_checked_value = /*selected*/ ctx[0] === 6;
    			attr_dev(input5, "class", "svelte-1tvgqix");
    			add_location(input5, file$5, 34, 6, 1104);
    			attr_dev(label5, "for", "num6");
    			attr_dev(label5, "class", "svelte-1tvgqix");
    			add_location(label5, file$5, 35, 6, 1212);
    			attr_dev(li5, "class", "svelte-1tvgqix");
    			add_location(li5, file$5, 33, 4, 1092);
    			attr_dev(input6, "type", "radio");
    			attr_dev(input6, "id", "num7");
    			attr_dev(input6, "name", "rating");
    			input6.value = "7";
    			input6.checked = input6_checked_value = /*selected*/ ctx[0] === 7;
    			attr_dev(input6, "class", "svelte-1tvgqix");
    			add_location(input6, file$5, 38, 6, 1268);
    			attr_dev(label6, "for", "num7");
    			attr_dev(label6, "class", "svelte-1tvgqix");
    			add_location(label6, file$5, 39, 6, 1376);
    			attr_dev(li6, "class", "svelte-1tvgqix");
    			add_location(li6, file$5, 37, 4, 1256);
    			...
    			attr_dev(input7, "class", "svelte-1tvgqix");
    			add_location(input7, file$5, 42, 6, 1432);
    			attr_dev(label7, "for", "num8");
    			attr_dev(label7, "class", "svelte-1tvgqix");
    			add_location(label7, file$5, 43, 6, 1540);
    			attr_dev(li7, "class", "svelte-1tvgqix");
    			add_location(li7, file$5, 41, 4, 1420);
    			...
    			attr_dev(input8, "class", "svelte-1tvgqix");
    			add_location(input8, file$5, 46, 6, 1596);
    			attr_dev(label8, "for", "num9");
    			attr_dev(label8, "class", "svelte-1tvgqix");
    			add_location(label8, file$5, 47, 6, 1704);
    			attr_dev(li8, "class", "svelte-1tvgqix");
    			add_location(li8, file$5, 45, 4, 1584);
    			...
    			attr_dev(input9, "class", "svelte-1tvgqix");
    			add_location(input9, file$5, 50, 6, 1760);
    			attr_dev(label9, "for", "num10");
    			attr_dev(label9, "class", "svelte-1tvgqix");
    			add_location(label9, file$5, 51, 6, 1871);
    			attr_dev(li9, "class", "svelte-1tvgqix");
    			add_location(li9, file$5, 49, 4, 1748);
    			attr_dev(ul, "class", "rating svelte-1tvgqix");
    			add_location(ul, file$5, 12, 0, 247);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (49:8) <Button disabled={btnDisabled} type='submit'>
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(49:8) <Button disabled={btnDisabled} type='submit'>",
    		ctx
    	});
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "message svelte-1i5k0xf");
    			add_location(div, file$4, 51, 4, 1354);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_default_slot$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h2, "class", "svelte-1i5k0xf");
    			add_location(h2, file$4, 43, 12, 924);
    			attr_dev(header, "class", "svelte-1i5k0xf");
    			add_location(header, file$4, 43, 4, 916);
    			attr_dev(input, "type", "text");
    			attr_dev(input, "placeholder", "Tell us something that keeps you coming back");
    			attr_dev(input, "class", "svelte-1i5k0xf");
    			add_location(input, file$4, 47, 8, 1128);
    			attr_dev(div, "class", "input-group svelte-1i5k0xf");
    			add_location(div, file$4, 46, 4, 1093);
    			add_location(form, file$4, 44, 0, 984);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			p = element("p");
    			t4 = text(t4_value);
    			attr_dev(div, "class", "num-display svelte-os8cuk");
    			add_location(div, file$3, 12, 0, 278);
    			attr_dev(button, "class", "close svelte-os8cuk");
    			add_location(button, file$3, 13, 0, 324);
    			attr_dev(p, "class", "text-display");
    			add_location(p, file$3, 14, 0, 396);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t0);
    ...
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file$2, 8, 0, 216);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h40, file$1, 6, 4, 103);
    			add_location(h41, file$1, 7, 4, 133);
    			attr_dev(div, "class", "feedback-stats svelte-16gsimh");
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file, 35, 1, 1111);
    			attr_dev(main, "class", "container");
    			add_location(main, file, 34, 0, 1085);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*average*/ 2) set_data_dev(t0, /*average*/ ctx[1]);
